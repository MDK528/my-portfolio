    ...
    <>
        <div className='w-full text-white'>
            ...
            <div className='px-16 py-4  flex flex-col md:flex md:flex-row '>
                <HashLink to="#skills" 
                className='text-base md:text-xl text-center font-mono m-2 rounded-4xl px-6 py-2 bg-gradient-to-r from-blue-500 to-teal-400  cursor-pointer hover:-translate-y-0.5'> 
                    Skills
                </HashLink>
