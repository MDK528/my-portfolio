    ...
    <>
        <footer className='w-full text-white border-t rounded-t-2xl border-gray-700'>
            ...
            <div className='flex gap-5 justify-center items-center my-5.5'>
                <Link to="https://github.com/MDK528" className='hover:translate-x-0 hover:-translate-y-0.5'>
                    <span>
                ...
                <span className='cursor-pointer hover:translate-x-0 hover:-translate-y-0.5'>
                ...
                <Link to="https://instagram.com/mdk_5_2_8" className=' hover:translate-x-0 hover:-translate-y-0.5'>
                    <span >
