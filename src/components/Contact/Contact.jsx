...
//       <div className='w-full px-10 py-5 text-white grid grid-cols-2'>
        
//         <div className='w-[60%] px-5 py-5 grid grid-rows-3 rounded-2xl bg-gradient-to-l from-green-500 to-blue-500'>
...
//             </span>
//             <span>
//               <a className='text-[20px]' href="mailto:mdkhalidhossain528@gmail.com?subject=Hello%20there&body=This%20is%20a%20test%20message">mdkhalidhossain528@gmail.com</a>
//             </span>
...
//             </span>
//             <span>
//               <a className='text-[20px]' href="https://wa.me/+919002149405" target="_blank">Chat on WhatsApp</a>
...
//             </span>
//             <span>
//               <a className='text-[20px]' href="tel:+919002149405">+919002149405</a>
//             </span>
//           </div>
...
//           <h1 className='text-2xl font-bold text-white'>On Social</h1>
//           <div className='flex gap-10'>
//             <a href='https://github.com/MDK528'>
...
//                 <a href="https://instagram.com/mdk_5_2_8">
//                     <span className='cursor-pointer'>
...
function Contact() {
  return (
    <>
      <section id='contact'>
        <div className='w-full px-10 py-8 text-white min-h-screen'>
  
        <div className='text-center mb-12'>
          <h1 className='text-2xl md:text-4xl font-bold mb-4'>Let's Get In Touch</h1>
          <p className='text-base md:text-xl text-gray-300'>Feel free to reach out through any of these</p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-16 max-w-6xl mx-auto'>
          ...
          <div className='space-y-8'>
            <h2 className='text-xl md:text-2xl font-bold text-center mb-8'>Contact Information</h2>
            
            <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-6 hover:scale-105 transition-transform duration-300'>
            ...
            <div className='bg-gradient-to-r from-green-600 to-teal-600 rounded-2xl p-6 hover:scale-105 transition-transform duration-300'>
              <div className='flex items-center gap-4'>
                <div className=' border p-3 rounded-full'>
            ...
            <div className='bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl p-6 hover:scale-105 transition-transform duration-300'>
              <div className='flex items-center gap-4'>
                <div className=' border p-3 rounded-full'>
          ...
          <div className='space-y-8'>
            <h2 className='text-xl md:text-2xl font-bold text-center mb-8'>Follow Me</h2>
                ...
                <div className='bg-gradient-to-r from-gray-800 to-gray-600 rounded-2xl p-6 hover:scale-105 transition-transform duration-300'>
                  <div className='flex items-center gap-4'>
                    ...
                    <div>
                      ...
                      <p className='text-sm md:text-lg text-gray-300'>Check out my code</p>
                    </div>
                  </div>
                </div>
              </a>
              ...
              <a href="https://instagram.com/mdk_5_2_8" className='block'>
                <div className='bg-gradient-to-r from-pink-600 to-purple-600 rounded-2xl p-6 hover:scale-105 transition-transform duration-300'>
                  <div className='flex items-center gap-4'>
                    ...
                    <div>
                      <h3 className='text-base md:text-lg font-semibold'>Instagram</h3>
                      <p className='text-sm md:text-lg text-pink-200'>Daily updates</p>
                    </div>
                  </div>
                </div>
              </a>
        ...
        <div className='text-center mt-16'>
          <div className='bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 max-w-2xl mx-auto'>
            <h3 className='text-xl md:text-2xl font-bold mb-4'>Ready to work together?</h3>
